...
import { Plus, FolderOpen, Trash2, Upload, Map as MapIcon, Clock, HelpCircle } from 'lucide-react';
                ...
                <div className="glass-panel" style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                        <h1 style={{ margin: 0, display: 'flex', alignItems: 'center', gap: '1rem', fontSize: '2rem' }}>
                            <img src="/logo.png" alt="Map Wiki" style={{ width: '48px', height: '48px', borderRadius: '10px' }} />
                            Map Projects
                        </h1>

                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                            <button className="btn-small" onClick={() => setShowHelp(true)} title="Help & Knowledge Base">
                    ...
                    <div className="project-list" style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '1rem', padding: '0.5rem' }}>
                        {projects.length === 0 ? (
